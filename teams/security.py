...
channel.queue_bind(
    exchange=exchange, queue=security_queue_name, routing_key="accident.security"
)
channel.queue_bind(
    exchange=exchange, queue=security_queue_name, routing_key="brawl.security"
)
channel.queue_bind(
    exchange=exchange, queue=security_queue_name, routing_key="not_on_list.security"
)
